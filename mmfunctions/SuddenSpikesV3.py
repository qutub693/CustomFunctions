...
class SuddenSpikesV3(SupervisedLearningTransformer):
...
#         raise Exception(log_stuff)
        ...
        if very_simple_model is not None:
            ...
            df[self.Anomaly] = np.where((abs(feature))>6000,feature,0)
    ...
    def build_ui(cls):
        ...
        outputs.append(UIFunctionOutSingle(name="Anomaly", datatype=float,
                                           description="Spike jump in value."))
